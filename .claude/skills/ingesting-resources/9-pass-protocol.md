...
If any fail condition surfaces, fix it in place in the deep reference, then re-audit. The deep reference does not ship until Pass I passes. Light and distillations derive from the audited deep, so the discipline propagates by construction.
