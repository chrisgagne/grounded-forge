...
The AAR axis is the event-triggered cross-functional counterpart to the iterative team-internal [[retro]] axis; see [`distillations/retro/RETRO-DISTILLATION-INDEX.md`](../retro/RETRO-DISTILLATION-INDEX.md) for the retro side of the same conversation.
