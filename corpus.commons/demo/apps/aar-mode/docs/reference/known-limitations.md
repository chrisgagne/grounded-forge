...
|---|---|---|
| 9-pass ingestion under source-only audit | Complete for 12 OpenStax books + 14 supplementary sources (26 references total) | [`references/`](../../references/), [`distillations/`](../../distillations/) |
