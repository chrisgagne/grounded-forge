...
4. **Operator-inspection `.md` views** (`REFERENCE-INDEX.md`, `DECISION-MAKING-DISTILLATION-INDEX.md`) when the user names a reference, author, or topic by name, or when the JSON routing leaves a gap and a wider scan helps.
