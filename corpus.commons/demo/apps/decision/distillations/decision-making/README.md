...
- `## Questions to Ask During a Decision`, phase-organised diagnostic tables. The canonical phase list lives in [`distillations/decision-making/DECISION-MAKING-DISTILLATION-INDEX.md`](DECISION-MAKING-DISTILLATION-INDEX.md); distillations use those phase names.
