...
**Moderate fire (doctrinal frame for high-tempo / high-uncertainty teams):**

- `mcdp1-warfighting-retro.md` — US Marine Corps MCDP-1 (1997). Public domain (US Government work product); scope=open. Doctrinal philosophy for teams operating in high-tempo / high-uncertainty / decentralised-execution contexts (SRE, startup, incident response, agile teams under heavy delivery pressure). Six retro threads: (1) *doctrine is a way of thinking, not a checklist* (Ch 3) — for teams treating runbooks / playbooks / standards as scripts; (2) *Schwerpunkt / main effort* (Ch 4) — *what is our main effort right now; could every team member state it in one sentence; would they agree?*; (3) *commander's intent must be understood two levels up* (Ch 4) — when the team doesn't know it, the leadership communication is the upstream cause; (4) OODA loop (Ch 2 Notes 18, credited to Boyd) — *what is our team's OODA tempo relative to the market / customer's; where is the Orient bottleneck?*; (5) *attrition vs maneuver* (Ch 2) — diagnose which mode the team is in and whether the situation rewards it; (6) *leniency on overbold errors, severity on errors of inaction* (Ch 3) — fear-of-mistakes cultures produce inaction.
