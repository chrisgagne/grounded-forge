...
6. **Self-determination theory (SDT)** — intrinsic motivation requires competence, autonomy, and relatedness; extrinsic rewards erode intrinsic motivation for interesting tasks (Ch 14.2, "Self-Determination Theory"). Retro experiments assigned rather than chosen produce lower follow-through; experiments the team designs themselves satisfy autonomy.
