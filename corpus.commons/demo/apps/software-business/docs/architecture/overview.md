...
Open [`references/openstax-organizational-behavior-deep.md`](../../references/openstax-organizational-behavior-deep.md). That is one distillation on the *reference axis*: a single source, ingested once, citations and evidence-classification markers in place.
