...
| Reference index | `reference-index.json` | — | Corpus catalogue. "Is there a reference on X?" Per source: author, year, title, primary topic, concept tags, scope, line counts. |
