...
- Task-application guidance. Diagnostic questions, anti-patterns, worked-example projections, integration tables. Those live in `distillations/{task}/`. The reference tier is faithful summarisation of the source; the projection tier is library-level synthesis.
