...
9. **CSR and the triple bottom line.** "Profits, people, and the planet" — the three dimensions for measuring stakeholder impact beyond shareholder profit. The text takes the position that authenticity is required: CSR-as-marketing damages brand. (Source: Ch 3.2)
...
14. **Consumer-stakeholder protection.** The FTC's unfair-trade-practice mandate covers six categories: product guarantees and false endorsements, unfair advertising (bait and switch), taking advantage of customers (vulnerable populations), misrepresenting a product, giving misleading price information, failing to disclose pertinent information. Plaintiffs do not need to prove intent. (Source: Ch 12.1)
