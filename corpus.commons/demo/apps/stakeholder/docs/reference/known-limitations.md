...
|---|---|---|
| 9-pass ingestion under source-only audit | Complete for 12 OpenStax books + 15 supplementary sources (27 references total) | [`references/`](../../references/), [`distillations/`](../../distillations/) |
