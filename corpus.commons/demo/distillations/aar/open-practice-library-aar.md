...
9. <!-- concept: impact-effort-prioritisation --> **Impact-Effort Prioritisation Matrix and RICE.** Two-axis 2×2 (high/low impact × high/low effort) and Reach × Impact × Confidence ÷ Effort. Used at Phase 4 (action design) when the AAR has surfaced more potential actions than the team can pursue. (Source: Practice "Impact-Effort Prioritisation Matrix"; Practice "RICE Prioritisation")
