...
**Borrowed-through gaps.** The Backcasting / Pre-mortem practice cites Gary Klein (HBR article) and Daniel Kahneman (*Thinking Fast and Slow*) borrowed-through as the method's originators; neither is held directly in the demo corpus. The Evals practice cites Andrej Karpathy's "march of nines" confidence-threshold framing borrowed-through; Karpathy is not held directly. The Human-in-the-Loop practice references a 1979 IBM framing ("A computer can never be held accountable, therefore a computer must never make a management decision") borrowed-through. The Liberating Structures Handbook is held directly in this corpus.
