...
4. **Reject "technical debt" as a financial concept.** The metaphor is incorrect — there is no debt, and there may not be any need for more work in the future. Apply real-options analysis instead: implementing functionality with minimum investment, with the intent of investing more later, has the form of an American call option, which may or may not be exercised. (Source: Ch 3.2.5, "Real options")
