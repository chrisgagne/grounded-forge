...
9. **Prototype fidelity as feedback-cost decision.** Low fidelity for high-level feature feedback (cheap to change); medium fidelity for small changes to accepted features; high fidelity for detailed tweaks. Choosing too high a fidelity for the question being asked wastes effort if the underlying decision changes. "If your client doesn't like your design, you might have saved time and communicated your concept just as well with a less elaborate paper prototype." (Source: Ch 6, opening; Ch 6.1)
