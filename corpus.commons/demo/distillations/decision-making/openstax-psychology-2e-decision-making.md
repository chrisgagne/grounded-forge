...
5. <!-- concept: fundamental-attribution-error --> **Fundamental attribution error.** Observers tend to overweight dispositional explanations and underweight situational ones when interpreting others' behaviour. The error is more pronounced in individualistic than collectivistic cultures. The implication for decision-making about people is that "they did it because of who they are" is often a more confident attribution than the evidence warrants. (Source: Ch 12.1, "Fundamental Attribution Error")

6. <!-- concept: self-serving-bias --> **Actor-observer asymmetry and self-serving bias.** People attribute others' behaviour to disposition and their own to situation; they attribute their own successes to disposition and failures to situation. This pair distorts both performance reviews and self-assessments. (Source: Ch 12.1)
