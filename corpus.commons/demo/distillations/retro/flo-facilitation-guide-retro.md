...
1. <!-- concept: facilitative-questions --> **Facilitative vs transmissive question framing.** A transmissive question delivers the facilitator's conclusion through the question; a facilitative question opens the participant's account (Ch 1, "What is facilitation in an educational context?"). For retros: the coach coaching the lead must consistently model facilitative questions. "What would the team say is the one thing that slowed us down?" opens the team's account. "Don't you think the deployment process is the issue?" transmits the lead's conclusion as a question.

2. <!-- concept: scaffolding --> **Scaffolding-and-fading arc — calibrate presence to phase.** "During the first week of each course, facilitator presence is high" (community builder and guide); as participants own the work, facilitators "step back and encourage learning through the use of different questioning strategies… they participate but don't lead" [V] (Ch 3, "Roles and functions of FLO facilitators"). For retros: Phase 0 (setup) and Phase 1 (priming) need the coach and lead visibly present and setting the container. Phase 2 (data gathering) and Phase 3 (insight) should be largely participant-owned, with the lead asking not answering.

3. <!-- concept: trust-the-process --> **Anxious Annie — name the worry, trust the process.** "Facilitation is not about me; it's about helping the participants as they need and ask for help. There is a saying that RRU folks often refer to called 'Trust the process.'" [V] [AE] (Ch 4, "Example of reflective post"). For retros: the lead who gets anxious when the team's stickies are sparse, or when a silent moment opens, will rush in and collapse the space. The coach's job is to name this pattern to the lead before the retro starts: "if silence opens, let it breathe for ten seconds before prompting."

4. <!-- concept: confidentiality-choice --> **Vegas rules as a trust foundation.** "Our learning relies on the exchange of honest, constructive feedback, and we need to agree on rules that support this foundation of trust" [V] (Ch 4, "Privacy and Confidentiality"). "You may wish to establish 'Vegas rules,' i.e. what happens in the course, stays in the course." [V] (Ch 4). For retros: this is a Phase 0 step, not optional. Especially critical when a manager is on the call.

5. <!-- concept: engagement-equity-tracking --> **Engagement-equity tracking matrix.** A simple spreadsheet — participant names, marks per interaction — distributes facilitation responses fairly [V] (Ch 6, "One idea to help you track interactions"). For retros: the coach tracks who has contributed in chat, who has spoken, who has been silent across the phases. The lead gets a heads-up ("you haven't heard from [Name] in twenty minutes") to prompt by name.

6. <!-- concept: no-pressuring-tone --> **No-pressuring-tone discipline.** "Avoid pressuring participants to comply with course deadlines, or suggesting they are only welcome if they are committed to following the activity plan. This is an informal, adult learning environment; expect that individuals will have their own agenda" [V] (Ch 7, "Write a welcome post"). For retros: the lead should not pressure the team toward a particular experiment or conclusion. The team owns the output; the lead facilitates.

7. <!-- concept: recording-consent --> **Recording as consent, not default.** "If recording synchronous sessions, confirm OK with session participants before hitting record" [V] (Ch 4, "Privacy and Confidentiality"). For retros: default is no recording. If the team wants to record for asynchronous review, every participant agrees explicitly.

8. <!-- concept: modelling-facilitation --> **Modelling-as-through-line.** FLO facilitators "model positive professional presence" and "model reflective practice as an online facilitator" [V] (Ch 3, "Developing FLO facilitation skills"). For retros: the lead models curiosity ("I don't know yet what the one constraint is — let's find out together"), the coach models transparent facilitation ("I'm going to ask this question to open space for the team, not because I think I know the answer").

9. <!-- concept: co-facilitation --> **Co-facilitation on complementarity criteria.** "I had a more technical background and my co-facilitator had more of the facilitation background… we complemented one another very well" [V] [AE] (Ch 7, "Two heads are better than one"). For retros where a coach is supporting a lead: the coach brings facilitation craft and process awareness; the lead brings team context and domain knowledge. Neither tries to do both.

10. <!-- concept: counsel-out --> **Counsel-out for deeply-struggling participants.** "If you find out a participant is deeply struggling, perhaps from an overwhelming schedule, your role is to help them decide if now is the right time to take the course" [V] (Ch 6, "Be in touch with participants who haven't logged in/aren't participating"). For retros: a team member who is visibly overwhelmed, in personal crisis, or clearly unsafe to engage may need a private conversation before or after the retro — not a public prompt during it.

11. <!-- concept: universal-design-for-learning --> **UDL multiple-means accessibility lens.** "Do I use facilitation strategies that may exclude some learners or present barriers to participation?" [V] (Ch 3, "Accessible design, inclusive facilitation"). For virtual retros: written-first input (chat waterfall) equalises non-native speakers, introverts, and high-power-distance participants. Captioning, camera-off options, and asynchronous follow-up for participants in difficult time zones reduce barriers.

12. <!-- concept: resist-thoroughness --> **Resist-thoroughness in feedback.** "Resist the urge to be thorough, but be clear that you're only commenting on one or two aspects of the artifact" [V] (Ch 7, "Monitor the sharing of drafts and prototypes"). For retros: the lead who gives feedback on every sticky collapses the team's ownership. Name the one or two that are load-bearing.
...
| Need | Question |
|---|---|
| Establishing Vegas rules | "Before we start: what's said in this retro stays here, unless we agree otherwise. Can everyone confirm that?" |
| Manager on the call | (Coach to lead, before retro): "Let's remind the team that [manager] is here to listen, not to evaluate — and ask them to speak last." |
| Safety check returns 1-2 | "The safety number tells me we're not quite ready to go into the retro content yet. Let's spend a few minutes on what would make it safer to speak openly today." |

### Phase 1 — Priming

| Need | Question |
|---|---|
| Lead is anxious about facilitating | (Coach to lead): "The silence that might open is the team thinking, not failing. Trust the process — let it breathe before you prompt." |
| Team is low energy | "Before we start — one word, in chat, that captures where you're coming into this retro from. Don't overthink it." |

### Phase 2 — Data Gathering

| Need | Question |
|---|---|
| Equity: a participant has not contributed in 20 minutes | "I want to hear from [Name] — what's your read on this one?" |
| Written-first vs verbal domination | "Let's get everything in chat first before we discuss. Everyone write your positives and deltas — we'll read the room together before anyone speaks." |

### Phase 3 — Insight / Cause Analysis

| Need | Question |
|---|---|
| Transmissive question arriving from the lead | (Coach to lead, quietly): "That question had your answer in it — try: 'What do you all see as the main thing driving this?'" |
| Conformity producing quick consensus | "Before we land on this, I want to check — is anyone holding a different view? Let's hear it now." |

### Phase 4 — Experiment Design

| Need | Question |
|---|---|
| Too many experiments on the board | "We've got five here. Which one, if we only did one, would change the most? Let's vote." |
| Experiment lacks a named owner | "Who specifically is taking this on — and by when? We don't close without a name and a date." |

### Phase 5 — Close

| Need | Question |
|---|---|
| Lead wants to thank the team | (Coach to lead): "End with the commitment read-back, link to next retro, then leave a moment for the team to debrief without you." |
| Participant visibly struggling | (After retro, to that participant privately): "I noticed you seemed stretched today. Is now a good time, or should we find another moment?" |
...
- The coach needs to calibrate when to intervene and when to hold back during the lead's facilitation.

Prefer the Approach Perfect Field Guide for the retro's protocol structure. Prefer the Liberating Structures Handbook for specific facilitation moves. This source is the craft-layer for the coach-lead relationship and the virtual facilitation context.
...
The scaffolding-and-fading arc, Anxious-Annie pattern, equity-tracking matrix, transmissive-question coaching, and counsel-out principle trace to the FLO Guide (Ch 3, "Roles and functions of FLO facilitators"; Ch 4, "Example of reflective post"; Ch 6, "One idea to help you track interactions"; Ch 4, "Privacy and Confidentiality"; Ch 6, "Be in touch with participants").

## Anti-patterns This Reference Helps Avoid

- Opening a virtual retro without an explicit Vegas-rules agreement, then being surprised when participants hedge their data.
- The lead (or coach) filling silence too quickly, collapsing the space that participants need to think before speaking.
- Letting the loudest voice fill Phase 2 while quieter participants observe — no equity-tracking means no equity.
- Recording the retro without explicit consent, chilling candour for the whole session.
- The coach doing domain-level facilitation work the lead should do, undermining the lead's credibility with the team.
- Pressing a deeply-struggling participant through the retro rather than naming that now may not be the right time.
- Transmissive questions from the lead that signal what answer is expected — the team produces that answer, not their actual data.
- Giving thoroughness-driven feedback on every sticky rather than naming the one or two that matter for the experiment.
- Skipping written-first input in favour of verbal-only, systematically advantaging the most verbally fluent and the most senior voice.
