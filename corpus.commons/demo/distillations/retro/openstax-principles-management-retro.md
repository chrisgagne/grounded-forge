...
Principles of Management projects onto the retro axis as a diagnostic substrate, not a facilitation methodology. Its core contribution is the set of frameworks that explain *why a team behaves as it does* in the moment the facilitator is coaching — why the team feels helpless, why the same problem recurs, why an experiment stalled, why the manager's presence is suppressing candour. PDCA frames the retro itself as the Check step in a learning cycle; without Act, the retro produces no improvement. Tuckman's stages explain team-dynamic behaviour that the facilitator reads as data, not as pathology. Motivation frameworks (Maslow, Herzberg, ERG, McClelland, SDT) give the lead a vocabulary for the *helpless team* diagnostic. Follett's integration path names the design target when experiment-design produces conflict. Change-management models frame what kind of change a retro experiment is and therefore which implementation path fits.

## Key Concepts for Retro

1. <!-- concept: pdca-cycle --> **PDCA / Deming-Shewhart cycle** — Plan → Do → Check → Act → return to Plan; the retro occupies the Check step and feeds Act (Ch 17.2, "Planning, Implementation, and Controlling"). Without a named Act step, the retro is Check without consequence.

2. <!-- concept: team-building --> **Tuckman's team-development stages** — forming (polite, surface similarities), storming (leadership contest, sides chosen), norming (working together, ground rules), performing (self-directed, congruence) (Ch 15.2, "Team Development Over Time"). Adding members or changing scope can regress the team. Storming retros produce contested data and blame language; performing retros surface root causes more readily.

3. <!-- concept: motivation --> **Herzberg's motivator-hygiene theory** — hygiene factors (pay, conditions, supervision, security) prevent dissatisfaction but do not motivate; motivators (achievement, recognition, work itself, growth) drive engagement (Ch 14.2, "Herzberg's Motivator-Hygiene Theory"). When a team cannot engage with retro content, hygiene-factor dissatisfaction may be crowding out motivational capacity. Address hygiene before expecting motivators to fire.

4. <!-- concept: maslow-erg --> **Maslow's hierarchy and ERG theory** — Maslow's five levels (physiological, safety, social, esteem, self-actualisation) with ERG's frustration-regression addition: when growth needs are blocked, attention regresses to relatedness (Ch 14.2). A team locked in safety-need concerns (job security, psychological safety) cannot self-actualise into continuous improvement.

5. <!-- concept: mcclelland-needs --> **McClelland's nAch / nAff / nPow** — achievement-oriented individuals want feedback and moderate-risk tasks; social-power seekers influence others toward group goals; affiliation-seekers prioritise relationships (Ch 14.2). High-nAch individuals drive retro experiment design; high-nAff individuals may resist experiments that threaten team cohesion; high-nPow individuals may own experiments that expand their influence.

6. <!-- concept: self-determination-theory --> **Self-determination theory (SDT)** — intrinsic motivation requires competence, autonomy, and relatedness. The signature SDT claim: "as the level of extrinsic rewards increases, the amount of intrinsic motivation decreases" [V] (Ch 14.2, "Self-Determination Theory"). Retro experiments assigned rather than chosen produce lower follow-through; experiments the team designs themselves satisfy autonomy.

7. <!-- concept: conflict-and-negotiation --> **Follett's three conflict paths** — dominance (one party dictates), compromise (neither gets what they want), integration (both state preferences, reach creative resolution) (Ch 3.6, "Follett and Conflict Resolution"). Integration is the design target for experiment-design disagreement; the library window example — "In the Harvard Library one day, in one of the smaller rooms, someone wanted the window open. I wanted it shut. We opened the window in the next room where no one was sitting" [V] (Ch 3.6) — models what integration looks like in practice.

8. <!-- concept: lencioni-five-dysfunctions --> **Lencioni's Five Dysfunctions** — absence of trust → fear of conflict → lack of commitment → avoidance of accountability → inattention to results (Ch 15.4, "Opportunities and Challenges to Team Building"). The chain begins at the foundation: "The first dysfunction is an absence of trust among team members. Essentially, this stems from their unwillingness to be vulnerable within the group. … This failure to build trust is damaging because it sets the tone for the second dysfunction: fear of conflict" [V] (Ch 15.4). When a retro displays artificial harmony (fast consensus, no disagreement), the second dysfunction — fear of conflict — is likely in play.

9. <!-- concept: cognitive-biases --> **Groupthink** — occurs when group members suppress dissent to preserve team spirit and avoid disrupting harmony (Ch 2.6). Counter-measures: assign a devil's advocate; form groups with diverse members; encourage everyone to speak. When a retro produces fast unanimity on experiments, groupthink may be operating.

10. <!-- concept: change-management --> **Four change-management models** — Lewin (unfreeze / change / refreeze, stable contexts), Kotter (urgency-driven, top-down, deficit-based), Cooperrider Appreciative Inquiry (abundance-based, bottom-up), Olson-Eoyang CAS (empower agents, strengthen connections, ensure flow) (Ch 10.3). The retro is most naturally an AI-type intervention: it asks "who are we when we are at our best?" before asking "what could be?" The choice of change model shapes whether the experiment is experienced as imposed or discovered.

11. <!-- concept: goal-setting --> **Goal theory (Locke)** — specific, difficult, accepted, committed-to goals produce better performance; participation in goal-setting increases commitment (Ch 14.3, "Goal Theory"). Retro experiments with vague success criteria do not produce Locke-compliant commitment. "Be more collaborative" is not a goal; "pair-review every PR before merge for the next two weeks" is.

12. <!-- concept: managing-as-paradox --> **Linda Hill on managing as paradox** — individual and collective goals; support and confrontation; performance and learning; authority and discretion; boundary management (Ch 15.3, "Things to Consider When Managing Teams"). When a lead engineer is struggling to hold the facilitation role, the paradox framing names why: they are being asked to hold authority and discretion in tension simultaneously.
...
| Need | Question |
|---|---|
| Read the team's stage | Are they forming (polite, surface), storming (contested), norming (ground-rules), or performing (self-directed)? What does that stage imply for how much structure the facilitator needs to impose? |
| Check for hygiene-factor suppression | Is there a live anxiety (job security, organisational change, manager conflict) that will prevent motivators from firing during the retro? If yes, name it before the content — or the content will not land. |

### Phase 1: Priming

| Need | Question |
|---|---|
| Diagnose the team's motivational profile | Is the team running on nAch (wants feedback and moderate-risk experiments), nAff (wants experiments that preserve relationships), or nPow (wants experiments that expand influence)? Shape the priming accordingly. |

### Phase 2: Data gathering

| Need | Question |
|---|---|
| Check for groupthink in data aggregation | When items cluster fast and dissent disappears, has group consensus been reached or has groupthink suppressed the outliers? Assign a devil's advocate or run Mini Constellations before closing. |
| Diagnose the helpless team | Is "nothing we can do" a safety-need response (the team does not feel secure enough to experiment) or an ERG frustration-regression (growth blocked, attention regressed to relatedness)? The diagnostic shapes whether the intervention is safety-building or autonomy-restoring. |
...
| Need | Question |
|---|---|
| Confirm the PDCA Act step is named | The retro is the Check step. Who owns Act, by when, and what enters the next Plan? If Act is unnamed, the retro is Check without consequence. |

## What to Look For

| Signal | Diagnosis | Follow-up |
|---|---|---|
| Team energy is flat; retro content isn't landing | Hygiene-factor dissatisfaction may be crowding out motivational capacity | Name the live anxiety before the content — or the content won't land |
| Team is in visible conflict; data is contested | Tuckman Storming stage; contested accounts are structural, not personal | Acknowledge the storm before data gathering; adjust the structure to match the stage |
...
- The team's motivational state needs diagnosis before the retro's content work can land — hygiene factors, Tuckman stage, or expectancy components are the diagnostic frames this source provides.
...
A coach is preparing to support a lead engineer who is running a retro for a team that is clearly in the Storming stage: two members had a public disagreement in the last Sprint Review, and the retro is the first meeting since.

Before Phase 0, the coach names the Tuckman reading to the lead: "This team is Storming. Data gathering will produce contested accounts. The structure needs to hold that without forcing resolution — the storm is normal." The lead opens Phase 0 with an acknowledgement: "This has been a hard Sprint. We're not here to resolve everything today. We're here to find one thing we can change."

Phase 2: written-first only. The lead collects stickies without discussion. The data is genuinely contested: four people name the PM-requirements ambiguity as the issue; two name the internal disagreement about technical approach. Both are present. The lead names both as data.
...
- Running a retro with a storming team without acknowledging the storm; the data-gathering phase will produce contested accounts, not shared insights.
- Designing retro experiments that require motivators to fire when hygiene factors are depleting the team's baseline capacity.
- Assigning experiments to team members without involving them in design; SDT predicts low intrinsic motivation and poor follow-through.
