...
Q3 foresight: 3a (agreed protocol exists — yes), 3b (workable and in routine use — *partially*). The policy required a senior-engineer code review but the implicit norm about reviewer-independence from the reporting line was not codified; the team had been routinely using manager-as-reviewer when no other senior was available. The safety property the policy aimed to produce had not been delivered. The CTO marks 3b as No — the protocol was honoured in letter but not in the safety property it was meant to provide. Any No to 3a, 3b, or 3c routes to Recommendation D: action singling out the engineer is unlikely to be appropriate; the wider actions may include, but not be limited to, the engineer. (Source: Q3, "Foresight test"; Q3, "Recommendation D")
