...
8. <!-- concept: cultural-path-dependence --> **Stakeholder culture is path-dependent.** Cultures develop through social learning, conformist transmission, and reciprocity. Stable cultures within a company persist beyond the people who established them. Cross-cultural stakeholder engagement involves navigating these path-dependent cultural differences. (Source: Ch 3.4.4, "Social learning"; Ch 4.4.2, "Culture")
