...
1. <!-- concept: legal-relationship-stakeholders --> **Stakeholders implied across legal relationships.** The text never gives a single stakeholder taxonomy, but stakeholders surface across chapters: employees (Ch 9), consumers (Ch 12), investors (Ch 14), the community (Ch 3 CSR), business partners and contracting counterparties (Ch 7-8), regulators (Ch 10-12), and competitors (Ch 11). Each carries distinct legal claims and standing. (Source: OpenStax, *Business Law I Essentials*, throughout)

2. <!-- concept: thomas-kilmann --> **Five negotiation styles (Thomas-Kilmann Conflict Mode Instrument).** Forcing, collaborating, compromising, avoiding, yielding. Each shapes a stakeholder interaction by the level of self-concern relative to other-concern. The text observes that yielding may signal an unfair power differential — important in stakeholder relationships where the firm is the dominant party. (Source: Ch 2.1, "Negotiation Style")

3. <!-- concept: relational-vs-outcome-goals --> **Relational vs outcome goals.** Relational goals build, maintain, or repair partnerships; outcome goals concentrate on end results. Continuing-relationship stakeholders warrant integrative (win-win) framing; one-time interactions may invite distributive (zero-sum) framing — but the long-term reputational cost of distributive framing should be priced. (Source: Ch 2.1, "Negotiation Types and Objectives")
