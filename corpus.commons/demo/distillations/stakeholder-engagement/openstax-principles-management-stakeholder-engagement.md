...
2. <!-- concept: stakeholder-analysis --> **Eight stakeholder-analysis questions.** The text offers eight questions for stakeholder analysis: who are the stakeholders, what are their stakes, what do supporters/resisters stand to gain/lose, what types of power do they have, what strategies retain support and win over resistance. The framework structures stakeholder mapping. (Source: Ch 5.6, Exhibit 5.8)

3. <!-- concept: stakeholder-theory --> **Stakeholder theory rejects shareholder-primacy.** The text takes an explicit position: "Maximizing shareholder wealth is often a short-sighted decision … [I]ncreasing the wealth of shareholders is not an acceptable reason for causing harm to others". Stakeholder theory argues that treating all constituencies fairly strengthens the firm's reputation, customer relations, and marketplace performance. (Source: Ch 2.1 and Ch 5.6)

4. <!-- concept: triple-bottom-line --> **Triple bottom line (TBL).** Profit, people, planet — measures financial, social, and environmental performance. CSR rests on the belief that corporations have social responsibility beyond pure profit. (Source: Ch 5.6)

5. <!-- concept: ethical-principles --> **Seven ethical principles for stakeholder reasoning.** Utilitarianism (consequentialist), universalism (duty-based), rights, justice, virtue ethics, common good, ethical relativism. Each frames stakeholder claims differently; ethical relativism is presented with explicit limits (it can enable abuses such as apartheid). (Source: Ch 5.3)

6. <!-- concept: power --> **French and Raven's five power bases.** Reward, coercive, referent, expert, legitimate. Stakeholders draw on different bases; recognising which base is in play shapes engagement strategy. Rationality, expertise, and moralistic appeal produce stronger commitment than reward or coercive power. (Source: Ch 13.3)

7. <!-- concept: hofstede-dimensions --> **Hofstede's four cultural dimensions.** Power distance, individualism vs collectivism, uncertainty avoidance, masculinity. Stakeholder engagement across cultures requires attention to all four; high-power-distance societies expect senior negotiators; high-collectivism societies make consensus decisions; high-uncertainty-avoidance societies want stability and rules. (Source: Ch 6.2)

8. <!-- concept: globe-leadership --> **GLOBE leadership profiles by cluster.** Six leadership profiles (charismatic, team-oriented, participative, humane-oriented, autonomous, self-protective) are rated differently across seven cultural clusters. Universally admired traits include trustworthy, dependable, intelligent, just, honest, decisive, encouraging. Universally disliked: loner, egocentric, antisocial, ruthless, dictatorial. (Source: Ch 6.3)

9. <!-- concept: cultural-intelligence --> **Cultural intelligence: head, body, heart.** Cognitive (training-based knowledge), physical (demeanor, eye contact, posture), emotional/motivational (confidence and motivation to adapt). Best practices: broaden the mind, develop skills through practice, boost cultural metacognition, develop cognitive complexity. (Source: Ch 15.6)

10. <!-- concept: multicultural-conflict --> **Four conflict sources in multicultural teams.** Direct vs indirect communication, trouble with accents and fluency, differing attitudes toward hierarchy, conflicting decision-making norms. Four interventions: adaptation, structural intervention, managerial intervention, exit. (Source: Ch 15.6)

11. <!-- concept: leader-member-exchange --> **Leader-Member Exchange (LMX).** Leadership as a set of dyadic relationships of varying quality. High-quality exchange relationships produce in-group members with higher performance, commitment, and satisfaction; low-quality produces out-group dynamics. Stakeholder engagement carries the same dyadic logic: each stakeholder relationship has its own quality trajectory. (Source: Ch 13.2)

12. <!-- concept: liaison-role --> **Mintzberg's liaison role.** Managers spend most of their time with peers across organisational boundaries (Stewart's 47 per cent finding). The liaison role establishes and maintains connections that produce the information and trust needed for stakeholder work. (Source: Ch 1.2 and Ch 16.3)

13. <!-- concept: follett-conflict-paths --> **Follett's three conflict-resolution paths.** Dominance (one party dictates terms), compromise (neither fully gets what they want), integration (both parties state preferences and reach a creative agreement). Integration is the strongest stakeholder-engagement outcome where stakes are high and relationships are ongoing. (Source: Ch 3.6)

14. <!-- concept: open-systems --> **Open systems and external alignment.** Organisations are open systems exchanging resources with their environment through feedback loops (Katz and Kahn). Stakeholder engagement is the human side of those resource exchanges; closed-system thinking misses the resource flows that determine viability. (Source: Ch 4.4)

15. <!-- concept: international-ethics-frameworks --> **FCPA, UN Global Compact, OECD frameworks.** The Foreign Corrupt Practices Act prohibits American firms from accepting/offering bribes to foreign officials. The UN Global Compact's ten principles guide international firms in less-developed countries. These frameworks ground cross-border stakeholder engagement under the single ethical standard. (Source: Ch 5.7)

16. <!-- concept: moral-entrepreneur --> **Brown-Trevino moral entrepreneur.** Someone who creates a new ethical norm or enforces a new norm through "the demonstration of normatively appropriate conduct through personal actions and interpersonal relationships, and the promotion of such conduct to followers through two-way communication, reinforcement, and decision-making". Stakeholder engagement at scale requires moral entrepreneurs in leadership positions. (Source: Ch 5.8)

17. <!-- concept: servant-leadership --> **Servant leadership and stewardship.** Servant leadership (Greenleaf): "selflessly working with followers to achieve shared goals that improve collective, rather than individual, welfare". Stewardship: empowering followers to make decisions and gain control over their work. Both anchor a stakeholder-pluralist leadership style. (Source: Ch 5.4)

18. <!-- concept: involvement-oriented-planning --> **Control-oriented vs involvement-oriented planning.** Control-oriented approaches emphasise top-down direction and tight monitoring; involvement-oriented approaches emphasise participatory goal-setting and self-managing work groups (Tavistock Institute, sociotechnical model). Many organisations (John Lewis Partnership, Volvo, Motorola) have had successful experiences with employee involvement. (Source: Ch 17.8)
