...
description: "Jones, Evidence-Based Software Engineering, projected onto the aar task axis; evidence markers and attribution travel in-band."
...
sources:
  - id: jones-evidence-based-sweng
    title: "Jones, D. M. (2020). Evidence-Based Software Engineering: based on the publicly available data. Version 1.0. Knowledge Software, Ltd. ISBN: 978-1-8382913-0-3. Licence: CC BY-SA 4.0 (copyleft propagates to derivatives). Scope: open."
    resource: http://www.knosof.co.uk/ESEUR/
generated:
...
**Same source, other task axes:** [decision-making](../decision-making/jones-evidence-based-sweng.md) · [retro](../retro/jones-evidence-based-sweng.md) · [software-business](../software-business/jones-evidence-based-sweng.md) · [stakeholder-engagement](../stakeholder-engagement/jones-evidence-based-sweng.md)
