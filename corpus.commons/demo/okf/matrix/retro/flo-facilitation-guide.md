...
description: "FLO Facilitation Guide, projected onto the retro task axis; evidence markers and attribution travel in-band."
...
5.  **Engagement-equity tracking matrix.** A simple spreadsheet — participant names, marks per interaction — distributes facilitation responses fairly [V] (Ch 6, "One idea to help you track interactions"). For retros: the coach tracks who has contributed in chat, who has spoken, who has been silent across the phases. The lead gets a heads-up ("you haven't heard from [Name] in twenty minutes") to prompt by name.

6.  **No-pressuring-tone discipline.** "Avoid pressuring participants to comply with course deadlines, or suggesting they are only welcome if they are committed to following the activity plan. This is an informal, adult learning environment; expect that individuals will have their own agenda" [V] (Ch 7, "Write a welcome post"). For retros: the lead should not pressure the team toward a particular experiment or conclusion. The team owns the output; the lead facilitates.

7.  **Recording as consent, not default.** "If recording synchronous sessions, confirm OK with session participants before hitting record" [V] (Ch 4, "Privacy and Confidentiality"). For retros: default is no recording. If the team wants to record for asynchronous review, every participant agrees explicitly.
...
**Same source, other task axes:** [aar](../aar/flo-facilitation-guide.md) · [decision-making](../decision-making/flo-facilitation-guide.md) · [stakeholder-engagement](../stakeholder-engagement/flo-facilitation-guide.md)
