...
description: "Letaw, Handbook of Software Engineering Methods, projected onto the retro task axis; evidence markers and attribution travel in-band."
...
sources:
  - id: letaw-handbook-sweng-methods
    title: "Letaw, L. (2024). Handbook of Software Engineering Methods (2nd ed.). Oregon State University. Licence: CC BY-NC 4.0 (non-commercial; copyleft propagates to NC derivatives). Scope: open-nc."
    resource: https://open.oregonstate.education/setextbook/
generated:
...
**Same source, other task axes:** [aar](../aar/letaw-handbook-sweng-methods.md) · [decision-making](../decision-making/letaw-handbook-sweng-methods.md) · [software-business](../software-business/letaw-handbook-sweng-methods.md) · [stakeholder-engagement](../stakeholder-engagement/letaw-handbook-sweng-methods.md)
