...
description: "NHS Improvement Just Culture Guide, projected onto the retro task axis; evidence markers and attribution travel in-band."
...
8.  **Borrowed-through Reason / NPSA lineage.** The poster attributes itself to "the work of Professor James Reason and the National Patient Safety Agency's Incident Decision Tree." Both are borrowed-through; the demo does not hold them directly.
...
**Same source, other task axes:** [aar](../aar/nhs-just-culture-guide.md) · [decision-making](../decision-making/nhs-just-culture-guide.md) · [software-business](../software-business/nhs-just-culture-guide.md) · [stakeholder-engagement](../stakeholder-engagement/nhs-just-culture-guide.md)
