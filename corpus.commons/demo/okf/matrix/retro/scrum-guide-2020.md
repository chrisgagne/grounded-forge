---
type: distillation
title: "Schwaber & Sutherland, The Scrum Guide 2020"
description: "Schwaber & Sutherland, The Scrum Guide 2020, projected onto the retro task axis; evidence markers and attribution travel in-band."
...
3.  **Assumptions surfaced, not just events recapped.** "Inspected elements often vary with the domain of work. Assumptions that led them astray are identified and their origins explored." The retro is not only a review of what happened; it is a probe of what was assumed to be true. (Source: Schwaber & Sutherland, *The Scrum Guide*, Scrum Events, "Sprint Retrospective")

4.  **Most impactful improvements, addressed as soon as possible.** "The Scrum Team identifies the most helpful changes to improve its effectiveness. The most impactful improvements are addressed as soon as possible. They may even be added to the Sprint Backlog for the next Sprint." Not the easiest, not the most popular — the most impactful. (Source: Schwaber & Sutherland, *The Scrum Guide*, Scrum Events, "Sprint Retrospective")
...
10.  **Framework immutability — partial retro is not a retro.** "While implementing only parts of Scrum is possible, the result is not Scrum. Scrum exists only in its entirety." A retro that skips data gathering, or closes without a commitment, is a debrief — not a retro. (Source: Schwaber & Sutherland, *The Scrum Guide*, End Note)

11.  **Empiricism over forecast tools.** "Only what has already happened may be used for forward-looking decision making." For Phase 4 experiment design: work from what this Sprint actually produced, not from what a prior Sprint's forecast said it would produce. (Source: Schwaber & Sutherland, *The Scrum Guide*, Scrum Events, "The Sprint")
