---
type: distillation
title: "Jones, Evidence-based Software Engineering"
description: "Jones, Evidence-based Software Engineering, projected onto the software-business task axis; evidence markers and attribution travel in-band."
resource: http://www.knosof.co.uk/ESEUR/
tags: [distillation, software-business]
task: software-business
scope: open
sources:
  - id: jones-evidence-based-sweng
    title: "Derek M. Jones (2020). Evidence-based Software Engineering: based on the publicly available data. Version 1.0. ISBN 978-1-8382913-0-3. CC BY-SA 4.0. http://www.knosof.co.uk/ESEUR/. Distribution note: This distillation is a derivative of a CC BY-SA 4.0 source and carries the same SA copyleft obligation."
    resource: http://www.knosof.co.uk/ESEUR/
generated:
...
**Same source, other task axes:** [aar](../aar/jones-evidence-based-sweng.md) · [decision-making](../decision-making/jones-evidence-based-sweng.md) · [retro](../retro/jones-evidence-based-sweng.md) · [stakeholder-engagement](../stakeholder-engagement/jones-evidence-based-sweng.md)
