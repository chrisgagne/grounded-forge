...
description: "Barbrook-Johnson & Penn, Systems Mapping, projected onto the stakeholder-engagement task axis; evidence markers and attribution travel in-band."
...
3.  **The "give away power" facilitation move.** "It is easy as a facilitator to feel responsibility for every moment of a workshop, and to try to control things too tightly. We recommended erring on the side of giving away power and responsibility to participants. Ask them to draw instead of you, ask them to ask questions of others, and critique the map as it emerges." This is the load-bearing facilitation principle across all the participatory methods. The Rich Pictures variant is more extreme — "leave the room entirely during the drawing stage". (Source: Ch 10, "Facilitating Discussion"; Ch 2, "Common Issues and 'Tricks of the Trade'")
...
8.  **The "rules of the game" front-loading principle.** "It is well worth spending an extra ten minutes at the start of workshop explaining the definitions of nodes and edges clearly, rather than discovering two hours in that people were misusing them." (Source: Ch 5, "Common Issues and 'Tricks of the Trade'")

9.  **The "always ask people to explain" facilitation move.** "Your most powerful prompt during a workshop is 'could you explain that a bit more please?' Do not worry about looking stupid or not knowing the system in question; you are not the expert, the stakeholders are. This will encourage discussion and precision in thought and will surface assumptions and disagreements." (Source: Ch 5, "Common Issues and 'Tricks of the Trade'")

10.  **The Rich Pictures icebreaker pattern.** "Have a handful of icebreaking suggestions to help participants get through blocks related to scepticism, feeling drawing is childish, feeling they cannot draw well, etc. ... One of the most used for people who are struggling to start (for any reason) is to ask them to draw themselves first (this can induce much laughter, quite literally breaking a static atmosphere)." The "ask them to draw themselves first" move is the canonical engagement icebreaker named in the book. (Source: Ch 2, "Common Issues and 'Tricks of the Trade'")

11.  **The "scale of engagement" tradeoff for facilitators.** Rich Pictures workshops can run in as little as 30 minutes if needed, but more commonly around 2 hours; groups of 3–6 per picture but whole groups as large as 50; perhaps as many as 20 participants per facilitator. PSM workshops are typically longer and more iterative across many sessions. Theory of Change can be done in a single workshop or many. System Dynamics participatory work ("group model building", "mediated modelling") is time-intensive. The engagement design should match what stakeholders can give. (Source: Ch 2, "How Do You Do Rich Pictures?"; Ch 5, "How Do You Do Participatory Systems Mapping?"; Ch 8, "How Do You Do System Dynamics?")

12.  **Stakeholder time pressure.** "Now, if you are lucky, you get a half day of people's time, and since the pandemic, you may only have people's attendance virtually. This puts more pressure on these methods, and this means we need to be better prepared and more efficient at using them." The acknowledgement that stakeholder availability is shrinking shapes the choice of method and the design of the engagement. (Source: Ch 1, "Why Think About Systems Mapping Now?")
