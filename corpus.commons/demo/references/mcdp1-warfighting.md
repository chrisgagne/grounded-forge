...
Full coverage of all 4 chapters plus Foreword, Preface, and Notes back matter. Image scope `text-only` — diagrams in the document are referenced in prose where they carry load. Citation style: chapter + section name; Notes references where load-bearing.
