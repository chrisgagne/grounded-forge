...
ingested: 2026-05-21
original_format: txt
converted_via: identity (txt → md)
checksum_sha256: 064cd1be0f243791319784b3c920d6a39de71ccc22202991f5713edfed917c27
---

# Source: MCDP 1 Warfighting (US Marine Corps, 1997)

The authoritative statement of U.S. Marine Corps warfighting philosophy. ~100 pages; Foreword + Preface + 4 chapters + Notes. Supersedes the 1989 FMFM-1 (Fleet Marine Force Manual 1) under which General Alfred M. Gray (29th Commandant) made the doctrinal pivot from attrition warfare to maneuver warfare. The 1997 revision under General Charles C. Krulak (31st Commandant) refined and expanded without altering the essential message.

US Government public-domain publication; freely distributable (PCN 142 000006 00).
...
**Cross-corpus note.** Identical content replicated into the public-tier `corpus.commons/demo/` corpus under slug-id `00q`. Source SHA256 identical; only frontmatter slug-id differs. Pass I audit covers both ingestions.
