...
- Beatrice Bruteau, *The Psychic Grid: How the Mind Operates*, Quest Books, 1979. In corpus at `corpus.local/aarbuddy/references/bruteau-psychic-grid.md` (light) and `bruteau-psychic-grid-deep.md` (deep). Chapter citations above resolve there.
