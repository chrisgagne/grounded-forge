...
Open [`corpus.commons/demo/references/openstax-organizational-behavior-deep.md`](../../corpus.commons/demo/references/openstax-organizational-behavior-deep.md). That is one reference on the *reference axis*: a single source, ingested once, citations and evidence-classification markers in place.
