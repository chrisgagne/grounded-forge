...
[`corpus.commons/demo/reference-index.json`](../../corpus.commons/demo/reference-index.json) answers "What is X?" for the corpus. One entry per source: slug-ID, author, year, title, primary topic, concept tags, scope, line counts.
